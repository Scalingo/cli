...
git push --set-upstream origin v1.44.0
```
...
> [Changelog] CLI - Release of version 1.44.0 https://cli.scalingo.com - More news at https://changelog.scalingo.com #cli #paas #changelog #bugfix
