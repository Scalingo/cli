...
```bash
git switch --create release/1.28.1
git add .
git commit -m "Bump version 1.28.1"
git push --set-upstream origin release/1.28.1
...
> [Changelog] CLI - Release of version 1.28.1 https://cli.scalingo.com - More news at https://changelog.scalingo.com #cli #paas #changelog #bugfix
