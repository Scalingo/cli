...
* feat(pgsql-console): add `psql-console` and `postgresql-console` aliases for `pgsql-console` command and replace duplicated commands by aliases [#693](https://github.com/Scalingo/cli/pull/693)
